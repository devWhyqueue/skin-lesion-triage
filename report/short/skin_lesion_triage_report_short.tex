...
\usepackage{xcolor}
\definecolor{headingcolor}{HTML}{3A3A40}
...
\title{Bayesian Decision and Uncertainty:\\Asymmetric Clinical Triage for Skin Lesions\thanks{Code and experiments are available at \url{https://github.com/devWhyqueue/skin-lesion-triage}.}}
\author{Yannik Queisler \and Furkan Akg\"un \and Malte Jonas Kriese}
\date{}
...
\appendix
\makeatletter
\renewcommand\@seccntformat[1]{\color{headingcolor}\csname the#1\endcsname\quad}
\makeatother
\section{\texorpdfstring{\color{headingcolor}Use of AI}{Use of AI}}
\color{headingcolor}
Generative AI tools were used throughout this project, including for coding, preparing this report, and creating the accompanying presentation. All content was reviewed and verified by the authors, who take full responsibility for it.
\color{black}
